// options-button.js
//
// The persistent "Options" button: opens the native game Options screen (Mods → Demographics), the
// single home for Demographics settings. Rendered at the right of the top-level view-tab row so it's
...
/**
 * Build the "Options" button. Clicking it opens the native Options screen (Mods → Demographics) via a
 * lazily-imported ContextManager; opening is best-effort (a no-op if the import fails).
