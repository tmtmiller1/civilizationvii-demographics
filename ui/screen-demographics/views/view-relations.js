...
import {
  makeFilterPillRow
} from "/demographics/ui/screen-demographics/views/relations-filters.js";
import { buildRingSvg } from "/demographics/ui/screen-demographics/views/relations-ring-svg.js";
import {
  getLocalId,
  getMetMajorIds,
  resolveMet
} from "/demographics/ui/screen-demographics/views/relations-queries.js";
import {
  makeFilterSetReader,
  makeFilterSetWriter,
  ...
  readShowUnmetNames,
  readTopTab
} from "/demographics/ui/screen-demographics/views/relations-settings.js";
import {
  applyCsEdgeOverrides,
  buildFilterDefs,
  computeCivRingData,
  computeCsRingData
} from "/demographics/ui/screen-demographics/views/relations-ring-compute.js";
 ...
 * @property {(id: number, viewerPid: number, showUnmetNames: boolean, localId: number|undefined, history: DemoHistory|undefined) => NodeInfo} buildCsNodeInfo
